...
//  Avocados
//
//  Created by Oleksii Vasyliev on 15.05.2023.
//
    ...
    var body: some View {
		VStack {
			...
			VStack(alignment: .center, spacing: 10) {
				...
				Text(ripeningStage.title.uppercased())
				...
				Text(ripeningStage.ripeness.uppercased())
...
struct RipeningView_Previews: PreviewProvider {
    static var previews: some View {
		RipeningView(ripeningStage: Ripening.ripening[0])
    }
}
